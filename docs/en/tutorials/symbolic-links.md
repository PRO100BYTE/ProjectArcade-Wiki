...
5. Your `C:\Retrobat\roms` folder will now show a 3do folder icon with a small arrow ![](</img/image (2) (1).png>)&#x20;
...
4. Your `C:\Retrobat\roms` folder will now show a 3do folder icon with a small arrow ![](</img/image (2) (1).png>)&#x20;
