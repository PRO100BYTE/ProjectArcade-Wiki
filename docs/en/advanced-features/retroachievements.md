...
Games that support RetroAchievements have a small trophy icon ![](</img/image (16).png>) in the Game View
...
To display the list of RetroAchievements available for a game, select it and hold the ![A](</img/image (25).png>) button, then choose **View this game's Achievements** in the [game options](../navigation/game-options.md) menu
